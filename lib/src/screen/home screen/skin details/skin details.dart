...
class _SkinDetailsScreenState extends State<SkinDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    print("LIKEIDDATA $likeIDData");
    print("LIKETITILEDATA $likeTitleData");
    return WillPopScope(
      onWillPop: () {
            ...
            Obx(
              () => Column(
                children: [
                  ...
                  Container(
                    height: ScreenSize.horizontalBlockSize! * 165,
                    color: Colors.transparent,
                    child: guide.value == false
                        ? SingleChildScrollView(
                            child: Column(
                              children: [
                                ...
                                minecraftNativeAD.getNative(
                                    "listTile", "/SkinDetailsScreen"),
                                SizedBox(height: ScreenSize.fSize_20()),
                                GestureDetector(
                                  onTap: () async {
